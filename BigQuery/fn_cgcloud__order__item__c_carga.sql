CREATE OR REPLACE TABLE FUNCTION ds_view_trusted.fn_cgcloud__order__item__c_carga(
  d_ini DATE, 
  d_fim DATE
)
RETURNS TABLE<
  cgcloud__order_ExternalId__c STRING,
  cgcloud__Product_externalid STRING,
  ExternalID__c STRING,
  ItemSAP__c STRING,
  item_category STRING,
  cgcloud__Quantity__c NUMERIC,
  ActualUnitValue__c NUMERIC,
  cgcloud__Base_Price_Receipt__c NUMERIC,
  cgcloud__Special_Price__c NUMERIC,
  SubstituicaoTributariaSAP__c NUMERIC,
  DiscountSAP__c NUMERIC,
  InternalComission__c NUMERIC,
  TotalInvoicedAmount__c NUMERIC,
  ActualMargin__c NUMERIC,
  MarginTax__c NUMERIC,
  MarginTaxSAP__c NUMERIC,
  MarginTaxCTB__c NUMERIC,
  MarginTaxCTBSAP__c NUMERIC,
  InvoiceNumber__c STRING,
  BillingDate__c DATE,
  DataAcordada__c DATE,
  ICMSSAP__c NUMERIC,
  cgcloud__Price_Receipt__c NUMERIC
>
AS (
