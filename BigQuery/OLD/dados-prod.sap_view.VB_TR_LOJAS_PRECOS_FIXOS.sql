...
with 
    ...
    (
        ...
        SELECT 
            fx.*, lf.func_par
        FROM 
            `dados-prod.sap.VH_TR_LOJAS_PRECO_FIXO` fx
        join 
            `dados-prod.sap.VH_MD_LOJAS_LIFNR`lf
    ...
    w_categoria as (
        ...
        from 
            ...
            --`dados-prod.sap_view.VB_TR_MATERIAL_CONTEXTOS`            
        where
...
left join
    ...
    dados-prod.sap.VH_TR_MAT_ULTIMA_COMPRA as ult
