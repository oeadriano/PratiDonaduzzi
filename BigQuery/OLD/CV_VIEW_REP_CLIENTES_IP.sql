/********* 
	...
	"_SYS_BIC"."CimedTech/CV_VIEW_REP_CLIENTES_IP"
	IP_PARAMETER: IP_LIFNR - Todos os clientes do representante
	GCP OK
	Incluir aqui os campos da detalhada
************/ 
...
SELECT 
	DISTINCT 
	LCLI.LIFNR, CLI.CODIGO, 
	CLI.CLI_RZS, CLI.CLI_CGC, CLI.CLI_END, '' as CLI_NUM, CLI.CLI_BAI, 
	CLI_CEP, CLI_EST, CLI.CLI_CID, CLI.CLI_TEL, CLI.CLI_EMAIL, CLI.CLI_LIMITE, 
	...
	CLI.BU, CLI.ASSOCIATIVISMO1, CLI.ASSOCIATIVISMO2, CLI.COD_REDE, CLI.NOME_REDE,
    case	   
...
JOIN 
	"_SYS_BIC"."CimedTech/CV_VIEW_LIFNR_CLIENTE" LCLI
...
LEFT JOIN					 
	...
	FROM "_SYS_BIC"."CimedTech/CV_VIEW_PARTIDAS_ABERTO_GERAL"
	where
