...
left join
	dados-dev.visoes_auxiliares_cimed_tech.CV_DIM_CLASSIFIC_MAT MST
	on MST.MANDT = MAR.MANDT
	and MST.OBJEK = MAR.MATNR 
	AND MST.ATNAM = 'MAT_STATUS'
    AND MST.ATINN = '0000000923'
left join 
