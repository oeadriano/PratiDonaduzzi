-- dados-dev.sap_view.VB_TR_PEDIDOS_CLIENTE_FAT
with w_cidade as (
  ...
  where
	...
	GROUP BY
		...
		VENDEDOR, PEDIDO_PORTAL, ETL_VENDA, CNPJCLIENTE, ERNAM, centro, ETL_FATURAMENTO
),
w_TVZBT as (
    select ZTERM, vtext
...
select
    ...
    ,D.ERNAM, D.CENTRO, D.ETL_FATURAMENTO,
