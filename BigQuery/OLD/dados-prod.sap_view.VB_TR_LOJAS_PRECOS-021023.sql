-- AEO - 25/04/23 versão com feature categoria_comissão (Ouro/diamante) - validado em QAS-- dados-prod.sap_view.VB_TR_LOJAS_PRECOS
...
with 
    ...
    w_cat_old AS (
        SELECT 
			codigo_sap__c, id_categoria, categoria_produto__c 
		FROM 			
