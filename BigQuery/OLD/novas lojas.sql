SELECT * FROM `dados-dev.visoes_cimed_tech.CV_A996_LOJAS_GERAL`
where
    lifnr = '0000604118' 
    and kunnr = '0001020245'
...
select 
    MAT.CODIGOBARRAS, MAT.DESCRICAO_MATERIAL, MAT.PRINCIPIOATIVO, MAT.GENERICO, MAT.LISTA, 
    MAT.CODIGO_MS, MAT.LINHA, MAT.STATUS, MAT.C_CONTROLADO, MAT.PRODUTO_HIERARQUIA AS MENU_CATEGORIA,
    MAT.cod_hierarquia as NUM_CATEGORIA, 
    ...
    0 AS VALOR_VC, 0 AS QDE_VC, 0 AS DISPONIVEL_VC,
    ult.vlr_unit AS ULT_COMPRA_VALOR, ult.ult_qde AS ULT_COMPRA_QDE, ult.erdat AS ULT_COMPRA_DATA,
	
    '' AS LGORT, '' AS MESES, 0 AS TRANSITO, 0 AS DISPONIVEL,     
	
    '' as filtro_contexto, 0 as num_filtro, 250 as pedido_minimo, 
...
mat.codigo, mat.codigobarras, mat.descricao_material, mat.principioativo, mat.generico, mat.lista, 
    ...
    ult.vlr_unit, ult.ult_qde, ult.erdat
